  ...
  const getReview = async () => {
    try {
      ...
      if (!dataResponse.success) {
        toast.error(dataResponse.message || "Failed to fetch reviews");
        return;
      }

      setReviews(dataResponse.data); // ✅ store reviews
      console.log("review data", dataResponse.data);
    } catch (error) {
        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="text-red-600 flex items-center gap-1">
              {reviews.length > 0 ? (
                // ⭐ If reviews exist, show average rating and list
                <div className="my-2">
                      ...
                      return (
                        <>
                          ...
                          <span className="ml-2 text-sm text-slate-600">
                            ({avgRating.toFixed(1)} / 5 from {reviews.length}{" "}
                            reviews)
                          </span>
                        </>
                      );
                ...
                // ⭐ Default full-star rating if no reviews found
                <div className="text-red-600 flex items-center gap-1">
                  <FaStar />
                  <FaStar />
                  <FaStar />
            ...
            {/* 🗨️ Reviews Section */}
            <div className="mt-6">
              <h3 className="text-xl font-semibold text-slate-800 border-b pb-2 mb-3">
                Reviews
              </h3>
